...
class Help extends Command {
  constructor (client) {
    super(client, {
      name: "help",
      description: "Get help on how to use ExSaudia Bot.",
      category: "General",
  ...
  async run (message, args, level, reply) { // eslint-disable-line no-unused-vars
      ...
      const emb = new Discord.MessageEmbed()
       ...
       if (!command) return reply(`<:redtick:911869301726773278> Command/Category/Alias not found.`);
