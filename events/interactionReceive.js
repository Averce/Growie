...
module.exports = class {
  ...
  async run (interaction) {
    ...
    if (!cmd) return reply(`<:redTicks:881763434822254693> Slash command not found? Please update the slash command list for your guild using \`${guild.settings.prefix}refresh\` and try again.`);
